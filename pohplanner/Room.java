...
public class Room {
	...
	private void initGarden(){
        ...
        this.hotspots = new Hotspot[] {
        	new Hotspot("Centrepiece", new int[]{ 268, 278, 278, 268, 268 }, new int[]{ 118, 118, 190, 190, 118 }, 4 ),
        	new Hotspot("Tree", new int[]{ 128, 190, 190, 128, 128 }, new int[]{ 10, 10, 90 , 90, 10 }, 4 ),
        	new Hotspot("Big Tree", new int[]{ 146, 222, 222, 146, 146  }, new int[]{ 168, 168, 262, 262, 168 }, 4 ),
        	new Hotspot("Small Plant 1", new int[]{ 196, 234, 234, 196, 196 }, new int[]{ 125, 125, 160, 160, 125 }, 4 ),
        	new Hotspot("Small Plant 2", new int[]{ 352, 392, 392, 352, 352 }, new int[]{ 158, 158, 195, 195, 158 }, 4 ),
        	new Hotspot("Big Plant 1", new int[]{ 370, 452, 452, 370, 370 }, new int[]{ 238, 238, 316, 316, 238 }, 4 ),
        	new Hotspot("Big Plant 2", new int[]{ 351, 406, 406, 351, 351 }, new int[]{ 24, 24, 89, 89, 24 }, 4 ),
        };
        this.imageURL = calculateRoomDoors();
